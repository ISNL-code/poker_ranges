// actions/JJ_raises_DB.ts
export const JJ_raises = {
  open_raise: {
    ...
    HJ: { min_eff_stack: 12, max_eff_stack: Infinity },
    CO: { min_eff_stack: 12, max_eff_stack: Infinity },
    BTN: { min_eff_stack: 10, max_eff_stack: Infinity },
  ...
  open_push: {
    ...
    HJ: { min_eff_stack: 0, max_eff_stack: 12 },
