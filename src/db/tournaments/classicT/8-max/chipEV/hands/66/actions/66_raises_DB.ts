export const _66_raises = {
  open_raise: {
    UTG: { min_eff_stack: 20, max_eff_stack: Infinity },
  ...
  open_push: {
    ...
    CO: { min_eff_stack: 0, max_eff_stack: 16 },
    BTN: { min_eff_stack: 0, max_eff_stack: 18 },
    SB: { min_eff_stack: 0, max_eff_stack: 16 },
    BB: null,
  },
};
